...
import com.zh.miaosha.exception.GlobalException;
import com.zh.miaosha.redis.MiaoshaUserKey;
...
import com.zh.miaosha.vo.LoginVo;
...
public class MiaoshaUserService {
    ...
    public MiaoshaUser getByToken(HttpServletResponse response, String token) {
        ...
        //根据传来的token 获取缓存中的user token是login的时候设置并存到redis里的
